   ...
   for ($y = 0; $y < $ysize; $y++) {
      ...
      for ($x = 0; $x < $xsize; $x++) {
            ...
            if ($centre=="1") {
               ...
               $x_dot = xdot($xcentre,$ycentre);
               $y_dot = ydot($xcentre,$ycentre);
            } else {
               $x_dot = xdot($xcoord, $ycoord, $inc_xcoord, $ycoord, $xcoord, $inc_ycoord);
               $y_dot = ydot($xcoord, $ycoord, $inc_xcoord, $ycoord, $xcoord, $inc_ycoord);
            }
            ...
            if ($centre=="1") {
               ...
               $x_dot = xdot($inc_xcoord, $inc_ycoord, $inc_xcoord, $ycoord, $xcoord, $inc_ycoord);
               $y_dot = ydot($inc_xcoord, $inc_ycoord, $inc_xcoord, $ycoord, $xcoord, $inc_ycoord);
            }
            if ($x_dot == 0) { ($vector_left_x, $vector_left_y) = (0, $y_dot);      } 
                        else { ($vector_left_x, $vector_left_y) = (1, $y_dot / $x_dot); }
