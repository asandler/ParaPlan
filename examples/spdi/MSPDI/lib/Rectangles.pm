...
#
# rectanglesCylinderCentre ((-10,-10), (10,10), (20,20)); or
...
#
# rectanglesCylinderCorners((-10,-10), (10,10), (20,20));
# rectanglesCorners((-10,-10), (10,10), (20,20));
#
#########################################################################

sub rectanglesCentre  { rectanglesGeneric("0","1",@_); }
sub rectanglesCorners { rectanglesGeneric("0","0",@_); }
sub rectanglesCylinderCentre  { rectanglesGeneric("1","1",@_); }
sub rectanglesCylinderCorners { rectanglesGeneric("1","0",@_); }
   ...
   for ($y = 0; $y < $ysize; $y++) {
      ...
      for ($x = 0; $x < $xsize; $x++) {
            ...
            if ($centre=="1") {
               ...
               $x_dot = xdot($xcoord,     $ycoord,     $inc_xcoord, $ycoord, 
                             $inc_xcoord, $inc_ycoord, $xcoord,     $inc_ycoord);
               $y_dot = ydot($xcoord,     $ycoord,     $inc_xcoord, $ycoord, 
                             $inc_xcoord, $inc_ycoord, $xcoord,     $inc_ycoord);
            }
            if ($x_dot == 0) { ($vector_left_x, $vector_left_y) = (0, $y_dot);          } 
                        else { ($vector_left_x, $vector_left_y) = (1, $y_dot / $x_dot); }
